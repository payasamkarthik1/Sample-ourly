...
function ProjectController(objectCollection) {
    ...
    app.post('/' + 'api/' + 'project/add/client/insert', async function (req, res) {
    ...
    app.post('/' +'api/' +  'project/remove/client/delete', async function (req, res) {
    ...
    app.post('/' +'api/' +  'project/update/client/details', async function (req, res) {
    ...
    app.get('/' + 'api/' + 'project/get/all/clients/select', async function (req, res) {
    ...
    app.post('/' +'api/' +  'project/add/projects/insert', async function (req, res) {
    ...
    app.post('/' + 'api/' + 'project/update/project/details', async function (req, res) {
    ...
    app.post('/' +'api/' +  'project/delete/project/remove', async function (req, res) {
    ...
    app.post('/' + 'api/' + 'project/inactive/to/active', async function (req, res) {
    ...
    //@Post project/remove/complete
    app.post('/' + 'api/' + 'project/remove/complete', async function (req, res) {
    ...
    app.get('/' + 'api/' + 'project/get/all/projects/select', async function (req, res) {
    ...
    app.get('/' + 'api/' + 'project/get/all/tags/list', async function (req, res) {
    ...
    app.post('/' + 'api/' + 'project/add/tag/insert', async function (req, res) {
    ...
    app.post('/' + 'api/' + 'project/remove/tag/delete', async function (req, res) {
    ...
    app.post('/' + 'api/' + 'project/update/tag/details', async function (req, res) {
